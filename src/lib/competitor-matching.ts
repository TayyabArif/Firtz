...
// Only run in Node.js environment (not in browser/Next.js build)
if (typeof require !== 'undefined' && typeof process !== 'undefined' && process.env.NODE_ENV !== 'production') {
  try {
    ...
    // Silently ignore in browser/build environments
  }
} 